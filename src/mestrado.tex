...
\begin{document}
  ...
  * break
  ...
  A forma de intera{\c c}\~ao de correntes com as ondas \'e atrav\'es dos termos de tens\~ao de radia{\c c}\~ao que principalmente em casos que o cizalhamento horizontal de corrente for diferente de zero, ou seja n\~ao uniforme, ocorre maior troca de energia entre as ondas e a corrente atrav\'es dos termos de fluxo de momento. Os principais casos em que este gradiente \'e diferente de zero s\~ao em instabilidades da corrente como meandros e v\'ortices.
  
  A Corrente do Brasil (CB) possui no campo de ondas na costa sul-sudeste. Para isso foram feitas simulac\~oes 
