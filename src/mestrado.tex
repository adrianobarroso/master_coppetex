...
\begin{document}
  ...
  \begin{abstract}
    ...
    No entanto, \'e bem conhecido os efeitos de correntes superficiais nas ondas, muitos trabalhos j\'a investigaram os 
    ...
    campo de ondas na costa sul-sudeste e quantificar o grau dessa influ\^ncia. Para isso foram feitas simulac\~oes 
    num\'ericas com o modelo de ondas Wave Watch III com dados de campo de corrente superficiais provenientes do modelo Hycom.
    Foram escolhidos eventos de alta instabilidade da CB para serem analisados com mais aprofundamento. 
